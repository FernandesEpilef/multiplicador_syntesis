...
# Generated on: Fri Jul 24 19:20:31 -03 2026 (Fri Jul 24 22:20:31 UTC 2026)
...
set logfile fv/ex_stage/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/ex_stage -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/usr/local/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/usr/local/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/usr/local/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/usr/local/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /usr/local/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/usr/local/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/usr/local/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/usr/local/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/usr/local/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/core_pkg.sv ../rtl/fp_new.sv ../rtl/multiplier.sv ../rtl/ex_stage.sv
elaborate_design -golden -root {ex_stage} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/ex_stage/fv_map.v.gz
elaborate_design -revised -root {ex_stage}
...
#add_name_alias fv/ex_stage/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box alu_DWIDTH32 fpnew_top_Featuresx00000010102_Implementationx000000014000000140000001400000014000000140000000c0000000c0000000c0000000c0000000c0000000800000008000000080000000800000008000000080000000800000008000000080000000aaaaa955aa9_DivSqrtSel1_TagType0h_TrueSIMDClass0_EnableSIMDMask0 opdiv -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.ex_stage.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.ex_stage.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.ex_stage.rtl.fv_map.rpt
